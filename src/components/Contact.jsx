...
function Contact() {
  return (
    <div className="w-full h-screen bg-gray-100  flex items-center justify-evenly">
      <div className="bg-gray-100  h-[30rem] w-[45rem] mx-16">
        ...
        <h1 className="text-gray-500 text-4xl mt-12">
