...
export function Footer() {
  return (
    <section title="footer" className="w-full bg-green-800">
          ...
          <div className="w-full sm:flex flex-row gap-x-12 flex-wrap justify-between">
            <div className="flex px-2">
              <div className="text-left">
                <h2 className="text-xl pt-2 font-extrabold font-md text-gray-100 capitalize">SwiftCare</h2>
                <p className="pt-2 text-sm font-md text-gray-100">Because Your Health Matters</p>
              </div>
            </div>
          ...
          <div className="m-auto flex flex-col">
            <div className="px-2 mt-4 flex flex-wrap justify-start gap-y-4 gap-x-12">
              <p className="text-sm font-md text-gray-100 capitalize">
                Developed By Team TechVoyagers
              </p>
