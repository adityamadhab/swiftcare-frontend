  ...
  return (
    <main style={{ backgroundImage: `url(${backgroundImage})` }}> 
      <div className="flex justify-center items-center">
        <div className="bg-white rounded-xl h-[40rem] mt-10 w-[25rem] border-2 border-black">
          <h1 className="text-center text-3xl font-bold text-gray-800 p-10">
            Welcome to the SwiftCare
          </h1>
          <form className="px-8 pt-6 pb-8 mb-4">
            ...
            <div className="flex items-center justify-center mt-4">
              ...
              <Link to={'/login'} className="pl-2 font-bold text-emerald-700">Login</Link>
            </div>
          </form>
        </div>
      </div>
